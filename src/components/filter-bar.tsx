...
export default function FilterBar(props: {
    ...
    const { displayDay, dayStrings, setDisplayDay } = props;
    /*let dayLabel = `${parseInt(displayDay.day)}`;
    switch (parseInt(displayDay.day) % 10) {
        case 1:
            dayLabel += 'st';
            break;
        case 2:
            ...
            <div className='flex-col-center'>
                ...
                <span className='relative z-0 inline-flex rounded-md shadow-sm'>
                    <button
                        ...
                        title={
                            props.isFirstDay()
                                ? 'no measurements before this day'
                                : ''
                        }
                    >
                    ...
                    <button
                        ...
                        title={
                            props.isLastDay()
                                ? 'no measurements after this day'
                                : ''
                        }
                    >
